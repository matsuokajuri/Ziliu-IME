...
| 项目 | 用途 | 许可证 | 固定 commit |
|---|---|---|---|
| FreeType | 通用字体文件加载与字形光栅化 | FreeType License (FTL) | `VER-2-14-3` |
...
FreeType 源码取自官方托管的 `2.14.3` 归档
`freetype-2.14.3.tar.xz`，SHA-256 为
`36bc4f1cc413335368ee656c42afca65c5a3987e8768cc28cf11ba775e785a5f`。
`ZiliuTextRaster.dll` 静态链接所需的 FreeType 模块；发行包必须保留本声明以及上游
`docs/FTL.TXT` 的完整许可文本。
